...
g <- ggplot(master_df, aes(Sector, Weight, fill=Var)) + geom_bar(stat="identity", position="dodge", width = 0.7, alpha = 0.8) + theme(text = element_text(size = 15), axis.text.x = element_text(angle=80, hjust=1)) + ggtitle(paste("Portfolio Distributions of Manhattan &",firm_of_interest))
g
